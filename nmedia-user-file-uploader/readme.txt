...
* Bug fixed: Admin were not able to download files now it is fixed
= 22.8 December 16, 2023 =
* Bug fixed: Files directories can be accessable outside scope. Now directories are secured
= 22.7 November 16, 2023 =
* Bug fixed: Download feature updated for secure purpose
= 22.6 October 23, 2023 =
* Bug fixed: Security issue fixed
= 22.5 October 23, 2023 =
* Bug fixed: [Download error fixed for shared files.](https://clients.najeebmedia.com/forums/topic/files-shared-with-me-cant-be-downloaded/#post-155099)
= 22.4 June 23, 2023 =
* Bug fixed: Filename validated when uploaded to AWS.
= 22.3 May 23, 2023 =
* Feature: Video duration added for video files info
= 22.2 May 17, 2023 =
* Bug fixed: Newly created files/dir not showing unless refresh
* Bug fixed: UI issues fixed
= 22.1 May 14, 2023 =
* Bug fixed: Missing setting issue fixed
= 22.0 May 14, 2023 =
* Feature: Using modern CSS, flexbox for best UI for every theme fit
* Feature: Removed Bootstrap CSS
* Feature: New UI for search, filters and groups
* Feature: Left navigation added
= 21.5 December 16, 2022 =
* Bug fixed: File upload issue fixed
= 21.4 September 21, 2022 =
* Bug fixed: Some warnings removed and security related issues fixed.
= 21.3 September 3, 2022 =
* Bug fixed: [Sometimes JS not triggered due to window load event delay](https://clients.najeebmedia.com/forums/topic/cannot-upload-files/)
* Bug fixed: File rename security issues fixed.
= 21.2 August 22, 2022 =
* Bug fixed: Filetype extension with uppercase letter is fixed.
= 21.2 May 13, 2022 =
